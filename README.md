...
The pipeline currently processes simulated cancer datasets (**Breast Adenocarcinoma** and **Prostate Adenocarcinoma**) and extracts key mutation metrics including:
...
- Enables comparison of mutation loads across tumor samples
